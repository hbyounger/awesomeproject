...
export default class {
    constructor(xx, yx, xy, yy, x, y){
        ...
        this.xx = _.isNull(xx) ? 1 : xx;
        this.yx = yx || 0;
        this.xy = xy || 0;
        this.yy = _.isNull(yy) ? 1 : yy;
        this.x = (_.isNull(x) ? this.x : x) || 0;
        this.y = (_.isNull(y) ? this.y : y) || 0;
        return this;
    }
    ...
    scale = (x, y) => {
        return this.transform(x, 0, 0, _.isNull(y) ? x : y, 0, 0);
    };
